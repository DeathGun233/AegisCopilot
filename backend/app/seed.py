...
| 国家/地区 | 渠道 | 品类 | 要求 | 限制 | 生效日期 |
| --- | --- | --- | --- | --- | --- |
| 德国 | DDP空派 | 液体 | 需要成分说明、MSDS | 单票需提前确认 | 2026-05-01 |
| 德国 | DDP空派 | 粉末 | 需要 MSDS、用途说明 | 单票需提前确认 | 2026-05-01 |

### 禁限运说明
- 德国 DDP 可以接内置电池产品，但纯电池不接。
- 带电产品需要提前提供 MSDS、UN38.3、运输鉴定书。
- 液体和粉末类产品需要提供 MSDS 或成分说明，并提前确认渠道承运限制。
        """,
...
- 费用币种以表格中的币种字段为准，当前偏远附加费币种为 USD。
        """,
        "department": "logistics",
